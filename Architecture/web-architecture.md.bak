...
4. The Request-Response Cycle
    ...
    Request: The Client sends a message (e.g., "Give me the homepage").

Processing: The Server receives the message, runs the necessary code, and fetches data.

Response: The Server sends back a message containing the requested data (HTML, CSS, JS, or JSON) along with a status code (e.g., 200 OK).